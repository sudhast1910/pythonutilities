...
path = "C:\\Example.xlsx"
#below is sample excel sheet data  - read columnB and if repo matches with dataToMatchinExcelAndUpdate first element then update columnC and columnD with second,third element value
#colomnB                           colomnC         colomnD                colomnE
#https://git.example.com/repo15
#https://git.example.com/repo1     origin/branch1  2022-03-20 18:07:08
#https://git.example.com/repo10

#loads excel file
wb_obj = openpyxl.load_workbook(path)
#gets active sheet in given excel sheet
...
# Iterate over each row in excel sheet 
